...
void Theme_Init(u32 themeId) {
	sIndex = themeId;
	{
		...
		sDarkTheme[THEME_SPLIT] =            (hsl_t) { 000.0 / 360, 0.0, 0.04 };
		...
		sDarkTheme[THEME_ELEMENT_BASE] =     (hsl_t) { 000.0 / 360, 0.0, 0.18 };
		...
		sDarkTheme[THEME_WARNING] =          (hsl_t) { 52.0 / 360, 0.5, 0.60 };
	}
	{
		...
		sLightTheme[THEME_WARNING] =         (hsl_t) { 52.0 / 360, 0.5, 0.60 };
	}
	{
		...
		sSpecialTheme[THEME_WARNING] =       (hsl_t) { 52.0 / 360, 0.5, 0.60 };
	}
}
