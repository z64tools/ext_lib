...
void* Arli_At(Arli* this, int64_t position) {
	if (!this->begin || position < 0 || position >= this->num)
		return NULL;
...
void Arli_Free(Arli* this) {
	delete(this->begin, this->copybuf);
	this->cur = this->num = 0;
}
...
int64_t Arli_IndexOf(Arli* this, void* elem) {
	if (elem >= (void*)(this->begin) && elem < (void*)(this->begin + this->elemSize * this->num))
		return (int64_t)(elem - (void*)this->begin) / this->elemSize;
	return -1;
}

void* Arli_Find(Arli* this, const void* data) {
	return memmem_align(this->elemSize, this->begin, this->elemSize * this->num, data, this->elemSize);
}
